@echo off
REM Restarts the HyperPulse backend: checks port 8100 for any live process and
...
echo Checking for existing process on port 8100...
set FOUND=0
...
if "%FOUND%"=="0" echo No existing process found on port 8100.
